...
export const ControlsMixin = (ModelViewerElement) => {
    ...
    class ControlsModelViewerElement extends ModelViewerElement {
        constructor() {
            ...
            this[_g] = (event) => this[$onChange](event);
            this[_h] = () => this[$onFocus]();
            this[_j] = () => this[$onBlur]();
            this[_k] = () => this[$onPromptTransitionend]();
        ...
        [(_a = $idleTime, _b = $userPromptedOnce, _c = $waitingToPromptUser, _d = $shouldPromptUserToInteract, _e = $idealCameraDistance, _f = $lastSpherical, _g = $changeHandler, _h = $focusHandler, _j = $blurHandler, _k = $promptTransitionendHandler, $updateFieldOfView)]() {
